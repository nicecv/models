...
def delf_v1_resnet_v1_50_block4(inputs,
                                num_classes=None,
                                is_training=True,
                                global_pool=True,
                                output_stride=None,
                                ...
                                reuse=None,
                                scope='delf_v1_resnet_v1_50_block4'):
                                
  model = DelfV1('resnet_v1_50/block4')
  logits, attention, feature_map = model.AttentionModel(
      ...
      attention_type=_SUPPORTED_ATTENTION_TYPES[0],
      kernel=1,
      training_resnet=True,
      training_attention=True,
      reuse=reuse)
  print(logits, attention, feature_map)
  return logits, {}
  
delf_v1_resnet_v1_50_block4.default_image_size = 224
